"""Code from Pyside6-Collapsible-Widget by EsoCoding : https://github.com/EsoCoding/PySide6-Collapsible-Widget"""
...
class Header(QWidget):
    ...
    def __init__(self, name, content_widget):
        ...
        background.setStyleSheet(
            "QLabel{ background-color: rgb(93, 93, 93); padding-top: -20px; border-radius:1px}"
        )
        ...
        self.icon.setStyleSheet(
            "QLabel { font-weight: bold; font-size: 15px; color: #000000 }"
        )
...
class Container(QWidget):
    ...
    def __init__(self, name, color_background=False):
        ...
        layout = QVBoxLayout(
            self
        )  # Create a QVBoxLayout instance and pass the current object as the parent
        ...
        self.expand = (
            header.expand
        )  # Assign the expand method of the header to the instance attribute expand
        self.toggle = (
    ...
    def contentWidget(self):
        ...
        return (
            self._content_widget
        )  # Return the _content_widget when the contentWidget property is accessed
